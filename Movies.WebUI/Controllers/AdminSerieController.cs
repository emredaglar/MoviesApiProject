...
namespace Movies.WebUI.Controllers
{
    public class AdminSerieController : Controller
    {
        ...
        public async Task<IActionResult> CreateSerie(CreateSerieDto createSerieDto)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:5106/api/Serie", stringContent);
        ...
        public async Task<IActionResult> UpdateSerie(int id)
        {
            ...
            var responseMessage2 = await client2.GetAsync("http://localhost:5106/api/Serie/GetSerie?id=" + id);
        ...
        public async Task<IActionResult> UpdateSerie(UpdateSerieDto updateSerieDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync("http://localhost:5106/api/Serie", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync("http://localhost:5106/api/Serie?id=" + id);
